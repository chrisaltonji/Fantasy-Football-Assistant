...
It reads raw and parsed and stops there — no state, no storage, nothing that
could collide with whatever you build on top of the library.
...
from espn_fantasy.draftroom import (  # noqa: E402
    CDP_DEFAULT_PORT,
    DraftRoomError,
    DraftRoomReader,
    RoomSnapshot,

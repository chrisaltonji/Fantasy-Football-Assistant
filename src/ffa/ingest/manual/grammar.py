...
VERBS: tuple[Verb, ...] = (
    ...
    Verb("watch", ("danger", "risk"), "watch",
         "Positions where more people need one than there are left."),
    Verb("plan", ("strategy",), "plan",
         "Your declared plan vs. what you have actually spent."),
    Verb("turns", ("turn", "order"), "turns",
         "Nomination order: who is up, when you are, and what to put up."),
